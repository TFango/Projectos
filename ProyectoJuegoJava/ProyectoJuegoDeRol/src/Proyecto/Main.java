    ...
    private static Personaje crearPersonaje(Scanner sc) {
        ...
        switch (claseSeleccionada) {
            ...
            case "3":
                ...
                break;
            default:
                System.out.println("Opcion no valida, creando un Guerrero por defecto.");
                nuevoPersonaje = new Guerrero(nombre);
                break;
        }

        System.out.println("Ingresa el nombre del archivo para guardar el personaje (ej. personaje.ser): ");
